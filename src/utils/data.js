...
const getIdentity = () => ({
  image: "images/project/pushkar.png",
  welcomeText: "Hi! I'm Puskar Raj",
  typeWriterText: [
    "Web Developer",
    "problem Solver",
  ...
  descriptionText:
    "Puskar Raj here, a CSE student at VIT Chennai specializing in Cyber-Physical Systems. With a passion for technology and innovation, I explore the intricate fusion of the digital and physical world. Eager to bridge the gap between theory and real-world applications. Join me in this journey of knowledge, problem-solving, and the endless possibilities of Cyber-Physical Systems.",
  contactText:
